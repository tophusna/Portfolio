export const techStack = [
  ...
  { name: "Unity", link: "https://cdnjs.cloudflare.com/ajax/libs/simple-icons/3.2.0/unity.svg" },
  // { name: "Maya", link: "https://iconduck.com/icons/102165/file-type-maya" },
  { name: "3DsMax", link: "https://iconape.com/wp-content/files/xk/122938/png/3ds-max-full-2.png" },
...
export const contactLinks = [
  ...
  { name: 'Stack Overflow', url: 'https://img.icons8.com/external-tal-revivo-color-tal-revivo/40/000000/external-stack-overflow-is-a-question-and-answer-site-for-professional-logo-color-tal-revivo.png' },
// { name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png', link: 'https://www.instagram.com/aakashsh1999/' },
{ name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png' },
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/tophusna'},
// { name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/aakashsh1999/'}
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png'}
]
...
export const serviceData = [
  {
    ...
    desc: 'Developed and maintained web applications using React, Node.js, and MongoDB. Implemented responsive user interfaces using HTML, CSS, and JavaScript libraries. Built RESTful APIs for seamless communication between front-end and back-end systems. Collaborated with UI/UX designers to create intuitive and visually appealing interfaces.',
...

  {
    ...
    desc: `Spearheaded the development of a highly acclaimed Unity- based game, integrating advanced 3D modeling and animation techniques Designed and 
    implemented complex gameplay systems using JavaScript and C#,  
    contributing to its critical, initiatives and conducted workshops on Unity, 3D modeling, and animation for the development team.`,
